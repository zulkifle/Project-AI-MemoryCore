...
| 2 | **[jumio-proxy-integration](./active/jumio-proxy-integration.md)** | 2026-06-09 | TBD | 80% | pilot-v2 ready — build JAR + docker + kubectl apply + nginx update to go live |
...
- **Last Updated**: 2026-06-09 - Saved jumio-proxy-integration: pilot-v2 ready for deployment
