...
|-----|---------|--------------|----------|------------|--------|
| 1 | **[Petronas Legacy C++ Dockerize](./active/petronas-legacy-cpp-dockerize.md)** | 2026-07-01 | 2026-06-05 ⚠️ | 85% | DB port configurable (ini). TEST: host.docker.internal:3306. PROD: mysqlrouter.mysqlrouter:6446 |
...
- **Last Updated**: 2026-07-01 - Petronas Legacy C++ Dockerize — DB port now configurable via ini (MySQL Router K8s ready)
