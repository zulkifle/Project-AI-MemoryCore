...
|-----|---------|--------------|----------|------------|--------|
| 1 | **[MyTrustID Desktop](./active/mytrustid-desktop.md)** | 2026-05-17 | TBD | 97% | LNA nested iframe diagnosed — bpfk needs `allow="local-network-access"` on outer iframe; JSPs updated with browser instruction box |
...
- **Last Updated**: 2026-05-17 - Save project: MyTrustID Desktop (LNA nested iframe diagnosis + JSP instruction box)
