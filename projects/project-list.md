...
|-----|---------|--------------|----------|------------|--------|
| 1 | **[Petronas Legacy C++ Dockerize](./active/petronas-legacy-cpp-dockerize.md)** | 2026-07-01 | 2026-06-05 ⚠️ | 85% | DB ini: 3 modes (localhost root / Docker tunnel / K8s mysqlrouter). Pending: rebuild + test |
...
- **Last Updated**: 2026-07-01 - Petronas Legacy C++ Dockerize — DB ini 3-mode setup (local/Docker/K8s)
