...
| 2 | **[jumio-proxy-integration](./active/jumio-proxy-integration.md)** | 2026-06-05 | TBD | 70% | Multi-project code done — 404 nginx path issue pending, needs rebuild + redeploy |
...
- **Last Updated**: 2026-06-08 - Saved unsaved MITI session: billing feature coded
